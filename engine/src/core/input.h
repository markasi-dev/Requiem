...
// Mouse input
RAPI b8 input_is_mouse_button_down(buttons button);
RAPI b8 input_is_mouse_button_released(buttons button);
RAPI b8 input_was_mouse_button_down(buttons button);
