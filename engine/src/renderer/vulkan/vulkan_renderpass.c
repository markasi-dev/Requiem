...
void vulkan_renderpass_create(
    ...
    color_attachment.initialLayout = VK_IMAGE_LAYOUT_UNDEFINED; // We dont care what layout we start with.
    color_attachment.finalLayout = VK_IMAGE_LAYOUT_PRESENT_SRC_KHR; // Transition to after renderpass
    color_attachment.flags = 0;

    attachment_description[0] = color_attachment;

    VkAttachmentReference color_attachment_reference = {};
    color_attachment_reference.attachment = 0; // Attachment_description array index.
    ...
    depth_attachment.initialLayout = VK_IMAGE_LAYOUT_UNDEFINED; // We dont care what layout we start with.
    depth_attachment.finalLayout = VK_IMAGE_LAYOUT_DEPTH_STENCIL_ATTACHMENT_OPTIMAL; // Transition to after renderpass

    attachment_description[1] = depth_attachment;

    VkAttachmentReference depth_attachment_reference = {};
    depth_attachment_reference.attachment = 1; // Attachment_description array index.
...
void vulkan_renderpass_begin(
    ...
    rq_zero_memory(clear_values, sizeof(VkClearValue) * 2);
