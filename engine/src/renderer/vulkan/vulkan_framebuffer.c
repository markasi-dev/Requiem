...
void vulkan_framebuffer_create(
    ...
    // Takes a copy of attachments, renderpass and attachment count.
    out_framebuffer->attachments = rq_allocate(sizeof(VkImageView) * attachment_count, MEMORY_TAG_RENDERER);
...
void vulkan_framebuffer_destroy(vulkan_context* context, vulkan_framebuffer* framebuffer) {
    ...
    if (framebuffer->attachments) {
        rq_free(framebuffer->attachments, sizeof(VkImageView) * framebuffer->attachment_count, MEMORY_TAG_RENDERER);
